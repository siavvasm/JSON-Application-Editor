             ...
             * in responsile for import a file that contains the deired JSON 
             * string.
             */
            ...
            /**
             * Checks if the JSON file provided as input adheres to the desired schema.
             */
             ...
             * updated in order to show its details.
             */   
            ...
            function saveButtonPressed() {
                // 2. Declare that the Save button is pressed
                save = true;
            ...
            /*
             * This function is responsible for defining the min and max Jobs per Second
            ...
            function getJobsPerSecAndValidate() {
                ...
                if (parseInt(min) <= parseInt(max)) {
                    ...
                    alert("The min Jobs per second are more than the max.");
                    return false;
                }
            }
            
            /**
             * This functions are responsible for exporting the final applications list
             * in a JSON format.
             */
            ...
            function exportJSONFile() {
                if(getJobsPerSecAndValidate()) {
                   ...
                   // TODO: Remove this print
                   console.log(document.getElementById("download-anchor"));                 
                }
            }
            ...
            function disableFields() {
                ...
                // Clear the value of the fields that correspond to the first implementation
                for (var i = 1; i < 5; i++) {
            ...
            function resetFields() {
                //TODO: Make this more generic - use the number of the checkboxes
                for(var i = 1; i < 5; i++) {
                    document.getElementById("acc-sup-imp" + i).readOnly = true;
                    document.getElementById("rho-imp" + i).readOnly = true;
                    document.getElementById("acc-sup-imp" + i).value = "";
